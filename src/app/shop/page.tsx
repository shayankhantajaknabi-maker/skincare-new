...
export default async function ShopPage() {
    ...
    const products = [...rawProducts].sort((first, second) => {
        const firstPack = first.packType || "single";
        const secondPack = second.packType || "single";

        return packOrder[firstPack] - packOrder[secondPack];
    });
            ...
            <main>
                <section className="nm-page-hero">
                    <div className="nm-wrap">
                        ...
                        <div className="mt-5">
                            <span className="nm-eyebrow">The Collection</span>
                        </div>

                        <h1>Shop NM Skin Care</h1>

                        <p className="mx-auto mt-4 max-w-[520px] text-[15.5px] leading-7 text-[#5c5c58]">
                            Pure and natural serum, available as a single bottle or as a
                            bundle for uninterrupted daily use.
                        </p>
                    </div>
                </section>
                ...
                <section className="nm-trust-strip">
                    <div className="nm-wrap nm-trust-grid">
                        <article className="nm-trust-item">
                            <span className="nm-trust-icon">♧</span>
                            <h2 style={{ color: "#ffffff" }}>Laboratory Tested</h2>
                        ...
                        <article className="nm-trust-item">
                            <span className="nm-trust-icon">♢</span>
                            <h2 style={{ color: "#ffffff" }}>Registered in Pakistan</h2>
                            <p style={{ color: "rgba(255,255,255,0.82)" }}>
                        ...
                        <article className="nm-trust-item">
                            <span className="nm-trust-icon">♡</span>
                            <h2 style={{ color: "#ffffff" }}>10,000+ Customers</h2>
                            <p style={{ color: "rgba(255,255,255,0.82)" }}>
                        ...
                        <article className="nm-trust-item">
                            <span className="nm-trust-icon">☰</span>
                            <h2 style={{ color: "#ffffff" }}>Cash on Delivery</h2>
                            <p style={{ color: "rgba(255,255,255,0.82)" }}>
                                Nationwide, 2–4 working days
                            </p>
                        </article>
                    </div>
                </section>

                <section className="nm-shop-section">
                    <div className="nm-wrap">
                        <div className="nm-shop-toolbar">
                            ...
                            <div className="flex items-center gap-3">
                                <span className="nm-eyebrow">Sort</span>
                        ...
                        {products.length === 0 ? (
                            ...
                            <div className="nm-product-grid">
                                {products.map((product) => {
                                    const packType = product.packType || "single";
                                    const units = product.units || packOrder[packType];
                                        ...
                                        >
                                            <div className="nm-product-thumb">
                                                <span className="nm-product-tag">
                                                    {product.badge || defaultBadge[packType]}
                                                </span>
                                            ...
                                            <div className="nm-product-body">
                                                <div className="nm-stars">★★★★★</div>

                                                <h2>{product.name}</h2>

                                                <p className="nm-product-description">
                                                    {product.shortDescription ||
                                                        `${units} × 20ml dropper bottle${units > 1 ? "s" : ""
